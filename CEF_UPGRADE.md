...
```
git checkout upstream/3440
git checkout -b 3440
git checkout -b 3440-valacef
```
...
```
git checkout 3440
git rebase upstream/3440
git checkout 3440-valacef
git rebase 3440
```
...
time python automate-git.py --download-dir=download \
  --url=/home/fenryxo/dev/projects/cef/cef --branch=3440 --checkout=origin/3440-valacef  \
