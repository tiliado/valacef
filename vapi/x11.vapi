...
namespace X {
	...
	public delegate int ErrorHandler(X.Display display, X.ErrorEvent event);

	[CCode (cname="XIOErrorHandler", has_target=false)]
	public delegate int IOErrorHandler(X.Display display);

	[CCode (cname = "XSetErrorHandler", cheader_filename = "X11/Xlib.h,X11/Xatom.h,X11/Xutil.h,X11/Xregion.h")]
	public ErrorHandler set_error_handler(ErrorHandler handler);

	[CCode (cname = "XSetIOErrorHandler")]
	public IOErrorHandler set_io_error_handler(IOErrorHandler handler);
}
